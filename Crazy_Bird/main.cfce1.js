(function () {
    ...
    function boot () {
        ...
        {
            var bundledScript = settings.debug ? 'src/project.dev.8abdf.js' : 'src/project.js';
            if (jsList) {
    ...
    if (false) {
        require(window._CCSettings.debug ? 'cocos2d-js.b634b.js' : 'cocos2d-js-min.js');
        var prevPipe = cc.loader.md5Pipe || cc.loader.assetLoader;
    ...
    if (window.document) {
        ...
        cocos2d.async = true;
        cocos2d.src = window._CCSettings.debug ? 'cocos2d-js.b634b.js' : 'cocos2d-js-min.js';
